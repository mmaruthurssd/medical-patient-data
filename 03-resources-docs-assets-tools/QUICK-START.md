...
- Git configured
- Access to medical-practice-workspace
...
Test access:
```bash
# From medical-practice-workspace
...
**Reference:**
- `~/Desktop/medical-practice-workspace/WORKSPACE_ARCHITECTURE.md` - Full system architecture
- `~/Desktop/medical-practice-workspace/planning-and-roadmap/three-workspace-architecture.md` - Workspace design
...
# (From medical-practice-workspace with Claude Code)
```
...
### MCP Tools (from medical-practice-workspace)
...
2. Review `~/Desktop/medical-practice-workspace/WORKSPACE_GUIDE.md`
