...
function createTimeTrigger_() {
  ScriptApp.newTrigger("fetchPayStubsMain")
    .timeBased()
    .everyDays(1)
    .atHour(22)
...
//   Logger.log(d)
  ...
  //let todayDate = new Date(2025, 10, d)
  ...
  let indexOfPaycor = columnA.indexOf("Paycor API");
  if (indexOfPaycor > -1) {
    dataUpdateLog.getRange(indexOfPaycor + 1, 4).setValue(new Date())
  }
