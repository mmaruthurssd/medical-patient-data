...
/**
 * this script has been moved to the SSD Needs Review sheet: https://docs.google.com/spreadsheets/d/13jZ9z3sJ7Xx0QcbA1R-LFmsTUezAYb6WslhhENbAwLk/edit#gid=0
 */
...
//const NEEDS_REVIEW_SS_ID = "13jZ9z3sJ7Xx0QcbA1R-LFmsTUezAYb6WslhhENbAwLk"
...
//   const SS = SpreadsheetApp.openById(NEEDS_REVIEW_SS_ID)

//   const FollowUpSheet = SS.getSheetByName('Needs Review');
...
//   let FollowUpHeaders = FollowUpSheet.getRange(1, 1, 1, FollowUpSheet.getLastColumn()).getDisplayValues()[0]
...
//   let DataHeaders = ConsolidatedSheet.getRange(1, 1, 1, ConsolidatedSheet.getLastColumn()).getDisplayValues()[0]
//   let dataHeadersObj = {};
//   DataHeaders.forEach((h, i) => {
//     dataHeadersObj[h] = i
//   })

//   let DataValues = ConsolidatedSheet.getRange(2, 1, ConsolidatedSheet.getLastRow() - 1, ConsolidatedSheet.getLastColumn()).getDisplayValues()
...
//   FollowUpSheet.getRange(2, 1, completeFirstRow - 3, FollowUpSheet.getLastColumn()).sort({ column: 2, ascending: false });
