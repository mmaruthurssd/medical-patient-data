...
echo "📋 Next Steps:"
echo ""
echo "1. Ensure service account has access to your Google Sheets:"
echo "   - Share each production sheet with: $SERVICE_ACCOUNT_EMAIL"
echo "   - Grant 'Editor' or 'Owner' permissions"
echo ""
