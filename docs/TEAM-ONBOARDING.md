...
git clone <operations-workspace-url> operations-workspace
...
# Check symlinks in operations-workspace
...
### Step 2: Copy Documentation from operations-workspace
...
```bash
cd ~/Desktop/operations-workspace/templates-and-patterns
...
```bash
cd ~/Desktop/operations-workspace/.claude/commands
...
### Step 5: Create Symlinks in operations-workspace
...
ln -s ../operations-workspace/projects-in-development projects-in-development
...
# If not, copy from operations-workspace:
cp ../operations-workspace/.git/hooks/pre-commit .git/hooks/
...
# From: /Users/mmaruthurnew/Desktop/operations-workspace/local-instances/mcp-servers/...
...
**1. operations-workspace** (Claude Code)
...
cd ~/Desktop/operations-workspace && git pull
...
# Edit files here (changes go to operations-workspace)
```
...
**In Claude Code (operations-workspace):**
```
...
- ❌ NEVER use patient data in operations-workspace
...
ls -la ~/Desktop/operations-workspace/shared-resources
...
- [ ] Understand workspace separation (NO PHI in operations-workspace)
