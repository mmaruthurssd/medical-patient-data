...
```
┌─────────────────────────────────────────────────────────────┐
│ 1. operations-workspace (Claude Code, NO PHI)        │
...
- ✅ Claude Code in operations-workspace (no PHI access)
...
# Same file accessible in operations-workspace automatically!
```
...
**Direct access to operations-workspace projects:**
...
│
├── projects-in-development/ → ../operations-workspace/projects-in-development/  (SYMLINK)
│   ├── Plant Baby Project
│   ├── Google Sheets Projects
│   ├── MCP Standardization Project
...
- Access to operations-workspace (on same machine)
...
2. **Access Development Projects**
   ```bash
   # Work on projects from operations-workspace
...
- **operations-workspace** - Main development hub (Claude Code)
...
```bash
# Verify symlink
ls -la projects-in-development  # Should show: -> ../operations-workspace/...
...
Shared Resources:
  ...
  → Symlinked from both operations-workspace and medical-patient-data
